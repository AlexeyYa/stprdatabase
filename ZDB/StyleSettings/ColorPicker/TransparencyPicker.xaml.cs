    ...
    internal partial class TransparencyPicker
    {
        public static readonly DependencyProperty ColorProperty 
            = DependencyProperty.Register(nameof(Color), typeof(Color), 
                typeof(TransparencyPicker), new FrameworkPropertyMetadata(Colors.Red));

        public static readonly DependencyProperty AlphaProperty
            = DependencyProperty.Register(nameof(Alpha), typeof(byte), 
                typeof(TransparencyPicker), new PropertyMetadata((byte)0, OnAlphaChanged));
