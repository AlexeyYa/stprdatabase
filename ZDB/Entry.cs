...
namespace ZDB
{
    //public class EntriesBind : BindingList<Entry>
    //{
    //    public EntriesBind() : base() { }
    //    public EntriesBind(BindingList<Entry> b) : base(b) { }

    //    private EntriesBind instance;
    //    public EntriesBind Instance
    //    {
    //        get
    //        {
    //            if (instance == null)
    ...
    //                db.Entries.Load();
    //                instance = new EntriesBind(db.Entries.Local.ToBindingList());// = db.Entries.Local.ToBindingList();
    //            }
    //            return instance;
    //        }
    //    }
    ...
    public class Entry : INotifyProppertyChangedExtended
    {
